...
public class HomePage {
    ...
    public void gotoBrokenImagespage (WebDriver driver){
        find_element(driver, brokenImagesRef).click();
    }

    public void gotoCheckBoxesPage (WebDriver driver){
        find_element(driver, checkBoxsRef).click();
    }

    public void gotoContextMenuPage (WebDriver driver){
        find_element(driver, contextMenuRef).click();
    }

    public void gotoDragAndDropPage (WebDriver driver){
        find_element(driver, draganddropRef).click();
    }

    public void gotoDropDownPage (WebDriver driver){
        find_element(driver, dropDrowRef).click(); 
    }

    public void gotoFileDownLoadPage (WebDriver driver){ 
        find_element(driver, fileDownLoadRef).click();
    }
